...
export const pool = new Pool({
  ...
  max: 10,
  // Force every connection this pool opens to resolve via IPv4.
  // This is more reliable than dns.setDefaultResultOrder() because it
  // doesn't depend on when/where that global setting runs relative to
  // module imports — it's applied per-connection, always.
  // TEMP: console.log added to confirm pg is actually calling this —
